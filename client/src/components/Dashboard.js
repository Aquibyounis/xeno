              ...
              <div className="table-responsive">
                <table className="modern-table">
                  <tbody>
                    ...
                    {!stats?.customersList?.length && (
                      <tr><td style={{textAlign: 'center', color: '#999', padding:'20px'}}>No data found</td></tr>
                    )}
                  </tbody>
                </table>
              </div>
